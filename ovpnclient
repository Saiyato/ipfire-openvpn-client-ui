...
my $settings  = "${General::swroot}/ovpnclient/settings";
my $status    = "${General::swroot}/ovpnclient/status";
my $sources   = "${General::swroot}/ovpnclient/sources";
...
sub configsite
{
  ...
  Header::openpage($Lang::tr{'ovpnclient'}, 1, '');
  Header::openbigbox('100%', 'left');
  error();
  Header::openbox('100%', 'left', $Lang::tr{'ovpn client config'});
...
;
  ...
  <tr>
    <td style='width:24em'>$Lang::tr{'ovpnclient use client'}</td>
...
<div class='sources'>
  ...
  <tr>
    ...
    <td>
        <select name='RATE' style='width:22em;'>
          <option value='SLOW' $slow_selected>$Lang::tr{'ovpnclient tcp'}</option>
          <option value='MEDIUM' $medium_selected>$Lang::tr{'ovpnclient udp'}</option>
        </select>
    </td>
  </tr>
  </table>
  ...
  <tr>
    <th align='left'>$Lang::tr{'ovpnclient table'}</th>
    <th align='left'>$Lang::tr{'ovpnclient chain'}</th>
    <th align='left'>$Lang::tr{'ovpnclient source'}</th>
    <th align='center'>$Lang::tr{'ovpnclient destination'}</th>
    <th align='center'>$Lang::tr{'ovpnclient protocol'}</th>
    <th align='center'>$Lang::tr{'ovpnclient action'}</th>
  </tr>
END
;
